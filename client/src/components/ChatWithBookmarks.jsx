    ...
    <div className={`mode-container chat-surface${docked ? ' is-docked' : ''}`}>
      ...
      <div className="chat-container">
        ...
        <div className="chat-input-area">
          ...
          />
          {loading ? (
            <button className="chat-send-btn stop" onClick={stop} title="Stop" aria-label="Stop answer">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="2"/></svg>
            </button>
          ) : (
            <button className="chat-send-btn" onClick={() => sendQuery(input)} disabled={!input.trim()} aria-label="Send">
