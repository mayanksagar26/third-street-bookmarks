...
// The app's party trick: point it at a computer and it works out where your
      ...
      while (true) {
        ...
        while ((newline = buffer.indexOf('\n')) >= 0) {
          ...
          if (event.type === 'progress') setProgress(event);
            ...
            if (!event.candidates.length) setError('No bookmark files found on this computer.');
          }
        }
      }
    } catch (e) {
    ...
    return (
      <div className="bf-idle">
        ...
        <p className="bf-idle-note">
          Searches the usual places on this computer, then asks {agentLabel} which file is
