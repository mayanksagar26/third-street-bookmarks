      ...
      >
        ...
        >
          ...
          {section === 'ai' && (
            <>
              <p className="set-lead">
                Powers chat, the podcast, and auto-categorising. Runs on this computer
          ...
          {section === 'bookmarks' && (
            <>
              ...
              <p className="set-lead">
                Point the app somewhere else. It searches this computer, then asks
          ...
          {section === 'about' && (
            <>
              <p className="set-lead">
                Third Street Bookmarks gathers your bookmarks locally. Nothing is
